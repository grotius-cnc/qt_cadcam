...
stretch_arc_array::stretch_arc_array(int i, bool startpoint, bool midpoint, bool endpoint, double dist_x, double dist_y, double dist_z)
{
    //write data array at once..

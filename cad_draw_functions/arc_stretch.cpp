...
arc_stretch::arc_stretch(int i, bool startpoint, bool endpoint, double dist_x, double dist_y, double dist_z)
{
    if(startpoint){
        ...
        X2 = double_cad_array[i][15]; //midpoint..
    ...
    if(endpoint){
        ...
        X2 = double_cad_array[i][15]; //midpoint on arc line..
        Y2 = double_cad_array[i][16];
        Z2 = double_cad_array[i][17];

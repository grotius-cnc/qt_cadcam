...
//    std::cout << endl;
    ...
    for(it = dept_0.begin(); it != dept_0.end(); it++){
        ...
        //input function = contournumbers...
        //output function inside.push_back(slave.at(i));
    ...
    //create level 0
    //cout << "** top level contourlist **" << endl;
    for(it = dept_0.begin(); it != dept_0.end(); ++it){

        if(!dept_1.contains(*it)){
            level_0_contour.push_back(*it);
            //cout << "level 0 contour : " << *it << endl;
        }
    }
    ...
    for(it = level_0_contour.begin(); it != level_0_contour.end(); ++it){
        ...
        //qDebug()<< "triangle id list : " << triangle; //is oke..
        //triangulation..
        triangulation(*it, triangle, 1,1 );
        triangle.clear();
    }

#include "window_select_stretch.h"
...
window_select_stretch::window_select_stretch(bool preview)
{
    ...
    if(select_click == 3){
        ...
        for(int i = 0; i < cad_counter; i++){
            ...
            if( (x_start < x_end) && (y_start > y_end) ){
                ...
                if(int_cad_array[i][0] == 1 || int_cad_array[i][0] == 3 || int_cad_array[i][0] == 4 || int_cad_array[i][0] == 5){ //id = line.. id = arc..
                    ...
                    if(double_cad_array[i][3] > x_start && double_cad_array[i][3] < x_end &&
                            double_cad_array[i][4] < y_start && double_cad_array[i][4] > y_end){

                        int_cad_array[i][7] = 1;
                    }
                    if(int_cad_array[i][6]==1 && int_cad_array[i][7]==1){
                        int_cad_array[i][3] = 1; //object select
                        int_cad_array[i][6] = 0;
                        int_cad_array[i][7] = 0;
                    }
            ...
            if( x_start > x_end && y_start < y_end ){
                ...
                if(int_cad_array[i][0] == 1 || int_cad_array[i][0] == 3 || int_cad_array[i][0] == 4 || int_cad_array[i][0] == 5 ){ //id = line.. id = arc..
                    ...
                    if(double_cad_array[i][0] < x_start && double_cad_array[i][0] > x_end &&
                            double_cad_array[i][1] > y_start && double_cad_array[i][1] < y_end){
                        int_cad_array[i][6] = 1; //startpoint
                    }
                    if(double_cad_array[i][3] < x_start && double_cad_array[i][3] > x_end &&
                            double_cad_array[i][4] > y_start && double_cad_array[i][4] < y_end){
                        int_cad_array[i][7] = 1; //endpoint
                    }
                    if(int_cad_array[i][6]==1 && int_cad_array[i][7]==1){
                        int_cad_array[i][3] = 1; //object select
                        int_cad_array[i][6] = 0;
